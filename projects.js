...
(function () {
  ...
  function initHome() {
    ...
    fetch(DATA_URL)
      ...
      .catch(function (err) {
        gridEl.innerHTML = "<p>Could not load project data. Please check project-data.json.</p>";
        console.error(err);
      });
  }
  ...
  function initDetail() {
    ...
    fetch(DATA_URL)
      ...
      .then(function (data) {
        ...
        if (!project) {
          root.innerHTML = "<p>Project not found. <a href=\"index.html\">Back to Work</a></p>";
          return;
        }
        ...
        var html = "";
        html += '<a class="back-link" href="index.html">&larr; Work</a>';
      ...
      .catch(function (err) {
        root.innerHTML = "<p>Could not load project data.</p>";
        console.error(err);
      });
  }
